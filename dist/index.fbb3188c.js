...
var _quizJs = require("./modules.js/quiz.js");
(0, _quizJs.renderQuestions)();
document.querySelector("#submit-btn").onclick = (0, _quizJs.submitAnswers);
document.querySelector("#reset-btn").onclick = (0, _quizJs.resetQuiz);

},{"./modules.js/quiz.js":"cJhFj"}],"cJhFj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderQuestions", ()=>renderQuestions);
parcelHelpers.export(exports, "submitAnswers", ()=>submitAnswers);
...
class Quiz {
    ...
    answerQuestion(selectedOption) {
        ...
        if (selectedOption === currentQuestion.correct_option) this.score++;
...
const quizData = [
    ...
    {
        question: "Who is the only wrestler to win the WWE Championship, Intercontinental Championship, and Tag Team Championship in their debut match?",
        options: [
            "Kurt Angle",
            "Brock Lesnar",
            "The Rock",
...
function submitAnswers() {
    ...
    forms.forEach((form, index)=>{
        ...
        const correctOptionLabel = form.querySelector(`label[data-correct="true"]`);
        if (selectedOption) {
            quiz.answerQuestion(selectedOption.value);
            const selectedLabel = form.querySelector(`label[for="${selectedOption.id}"]`);
            if (selectedOption.value !== quiz.questions[index].correct_option) selectedLabel.style.backgroundColor = "red";
            else // Optional: You could highlight the correct answer in green here if you like
            selectedLabel.style.backgroundColor = "green", selectedLabel.style.color = "white";
        }
    });
    renderResult();
}
...
function resetQuiz() {
    ...
    document.querySelectorAll("#quiz-form label").forEach((label)=>{
        label.style.backgroundColor = ""; // Remove any inline style modifications
    });
...
},{}]},["kzbYw","bDbGG"], "bDbGG", "parcelRequireefdf")
